...
# Upload file (uncomment the line below to upload in a Jupyter environment)
# from google.colab import files
# uploaded = files.upload()

# Load the data file
file_path = '/content/Data Sheet 1.csv'  # Replace with your file path
df = pd.read_csv(file_path)

# Show the first few rows of the data to understand the structure
df.head()
